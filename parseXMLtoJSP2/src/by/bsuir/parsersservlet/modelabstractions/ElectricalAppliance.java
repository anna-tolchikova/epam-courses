package by.bsuir.parsersservlet.modelabstractions;
...
public abstract class ElectricalAppliance implements Comparable<ElectricalAppliance> {
    ...
    public String toString() {
        return " isSwitchedOn = " + this.isSwitchedOn + " maxPowerConsumption = " + this.maxPowerConsumption + " producer = " + this.producer + " model = " + model;
    }
